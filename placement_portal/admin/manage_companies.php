            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <?php endif; ?>
                         <a href="?action=delete&id=<?php echo $c['id']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Delete this company? This will remove all their jobs!')"><i class="fas fa-trash"></i></a>
                    </td>
                </tr>
                <?php endforeach; ?>
            </tbody>
